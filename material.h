...
class lambertian : public material{
    public:
        ...
        double scattering_pdf(const ray& r_in, const hit_record& rec, const ray& scattered) const override {
            ...
            // If you aren't sure what the best sampling pattern for your material is, it's pretty reasonable to just go ahead and assume a uniform PDF, and while that might converge slowly, 
            // it's not going to ruin your render. 
